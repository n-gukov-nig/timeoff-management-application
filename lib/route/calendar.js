...
router.get('/', function(req, res) {
  ...
  Promise.join(
    ...
    req.user.promise_vacation(),
    function(calendar, company, user, supervisors, user_allowance, vacation){

      console.log('vacation_duration', vacation.total)
      console.log('available', vacation.available)
      let
